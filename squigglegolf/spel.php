...
<body>
  ...
  <div class="canvas-container">
    <div id="canvas-overlay">
      ...
      <div id="tutorial">
        ...
        <svg viewBox="0 0 420 30">
          <text x="0" y="15">1. Klicka och dra för att sikta</text>
        </svg>
        <svg viewBox="0 0 420 30">
          <text x="0" y="15">2. Släpp för att slå</text>
        </svg>
        <svg viewBox="0 0 420 30">
          <text x="0" y="15">3. Sikta på hålet!</text>
        </svg>
        <svg viewBox="0 0 420 30">
          <text x="0" y="15">4. Man kan dubbelhoppa genom att dra en gång till i luften</text>
        </svg>
          <br/>
          <br/>
        <svg viewBox="0 0 420 30">
  ...
  <br>
  <br>
  <br><a id="yesterday">Spela igårs bana!</a>
  <br>
...
async function handleEnd(reason) {
    if (reason === "death") {
        ...
        if (strokes === 1) {
            alert("⛳ Hole in one baby!! ⛳");
        } else {
            alert(`Du klarade hålen i ${strokes} slag!`);
        }
    }
